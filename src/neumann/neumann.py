...
from neumann.logic_utils import add_true_atoms, get_index_by_predname, true
...
class NEUMANN(nn.Module):
    ...
    def __init__(self, clauses, atoms, facts_converter, message_passing_module, reasoning_graph_module, program_size, device, bk=None, bk_clauses=None, train=False, softmax_tmp=1.0, explain=False):
        super().__init__()
        self.atoms = atoms
