...
class StandardMLP(nn.Module):
    """
    Standard Feedforward Multi-Layer Perceptron (Basic DNN baseline) for CCHS sepsis policy.
    """
    def __init__(
        self,
        device=None,
    ...
    def _print(self) -> str:
        ...
        return f"CCHS Standard MLP Agent - In: {self.num_in_features}, Out: {self.out_size}, Trainable Params: {param_count:,}"
